...
>
  ...
  />
            ...
            <Box sx={{ display: "flex", justifyContent: "center", gap: 1.5, marginBottom: 2 }}>
              {Array(4)
                .fill("")
                .map((_, index) => (
                  <input
 ...
 <Grid item xs={12} sm={6} md={4}>
  ...
  {/* Postal Address */}
  <Grid container spacing={2} alignItems="center" sx={{ paddingLeft: 4,marginTop: 1}}>
  <Grid item xs={12} sm={6} md={4}>
    <TextField
      fullWidth
...
<Grid container spacing={2} alignItems="center" sx={{ paddingLeft: 4 }}>
  {/* Institute Category */}
  <Grid item xs={12} sm={6} md={4}>
    <FormControl fullWidth>
